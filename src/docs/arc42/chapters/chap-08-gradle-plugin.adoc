...
<1> The actual plugin code: `HtmlSanityCheckPlugin.groovy` and `HtmlSanityCheckTask.groovy` Groovy files
...
==== Passing Parameters From Build file to Plugin
To be done
...
The https://www.gradle.org/docs/current/userguide/custom_plugins.html[Gradle user guide] describes how to write a plugin.
