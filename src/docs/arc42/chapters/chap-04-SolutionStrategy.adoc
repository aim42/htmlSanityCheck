...
** Implement a core library for the functionality with minimal external dependencies and tool independent.
...
See the {xrefConceptCheckingAlgorithms},
** Both HTML (file) and text (console) output.
See the {xrefConceptReporting}.
