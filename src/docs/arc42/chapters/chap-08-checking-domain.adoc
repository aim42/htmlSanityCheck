...
| Html Element      | HTML pages (documents) are made up by HTML elements .e.g., `<a href="link target">`, `<img src="image.png">` and others. See the https://www.w3schools.com/html/html_elements.asp[W3-Consortium]
...
| URI               | Universal Resource Identifier. Defined in https://www.ietf.org/rfc/rfc2396.txt[RFC-2396]. The ultimate source of truth concerning link syntax and semantic.
|===
