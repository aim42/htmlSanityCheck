...
:coresourcepath: ../../../src/main/groovy/org/aim42
:coretestpath:   ../../../src/test/groovy/org/aim42
...
image:http://img.shields.io/badge/license-ccsa4-green.png[link="https://creativecommons.org/licenses/by-sa/4.0/"^]
image:http://img.shields.io/github/issues/aim42/{project}.png[link={project-issues}]

image::{improveDocImage}[link={repositoryDocsDir}hsc_arc42.adoc, float=right]
