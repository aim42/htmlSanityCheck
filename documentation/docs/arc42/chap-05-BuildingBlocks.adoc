...
| Finding              
| a single finding, (e.g. "image 'logo.png' misssing"). Can hold suggestions
...
(`CheckResults`). See the interface definitions below - taken from the Groovy-sourcecode:
...
----
include::{sourcepath}/htmlsanitycheck/collect/RunResults.groovy[tags=RunResultInterface]
----
...
----
include::{sourcepath}/htmlsanitycheck/collect/PageResults.groovy[tags=PageResultInterface]
----
...
----
include::{sourcepath}/htmlsanitycheck/collect/CheckResults.groovy[tags=CheckResultsInterface]
----
