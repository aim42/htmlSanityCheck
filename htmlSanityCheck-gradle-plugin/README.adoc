...
image:https://img.shields.io/gradle-plugin-portal/v/org.aim42.htmlSanityCheck[Gradle Plugin Portal Version]
image:https://img.shields.io/maven-central/v/org.aim42.htmlSanityCheck/org.aim42.htmlSanityCheck.gradle.plugin[Maven Central Version]
...
<4> Check out <<box:current-version,current version>>.

[[box:current-version]]
[IMPORTANT]
.Latest (development) version
====
// TODO differentiate between released/latest (from main branch) and develop(ment) versions as soon as current develop branch is merged to main
