...
Big thanx to image:src/docs/images/structure101-logo.png[alt='Structure-101',link="src/docs/images/structure101-logo.png"] for helping us analyze and restructure our code.