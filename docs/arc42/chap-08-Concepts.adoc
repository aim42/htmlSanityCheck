...
<5> report the nr of checks and problems plus the success rate

<6> for every check, report a summary and <7> all detailed findings.

<7> for every checked page, create a footer, pagebreak or similar to graphically distringuish
